      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="http://localhost/gmailviews/sent_items.php">Sent Items</a></li>
            <li><a href="http://localhost/gmailviews/draft.php">Draft</a></li>
            <li class="active"><a href="http://localhost/gmailviews/trash.php">Trash <span class="sr-only">(current)</span></a></li>    
          </ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 id="subHeader" class="sub-header">Trash</h2>
...
function updatehtml(){
  ...
  {
    //alert(i);
     document.getElementById("inboxtable").innerHTML += "<tr id=\"mail"+i+"\" onclick='showmailRow("+i+")' style=\"font-weight: 600;\">" + "<td>"+mails[i].mail_details.timestamp +"</td><td>"+mails[i].mail_details.sender +"</td><td>"+mails[i].mail_details.subject+"</td><td>"+mails[i].mail_details.body+"</td>" + "<td><button type='button' onclick='undomail("+i+")'>Undo</button></td></tr>";
     isread(i);
  }
}
...
//alert("load");
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": "http://localhost/gmail/trash",
    "method": "GET",
    "headers": {
      "content-type": "application/x-www-form-urlencoded",
      "email": getCookie("email"),
